...
if __name__ == "__main__":
    ...
    filename = CONF[json_comp_conf]["pickle_path"] + "data_21x21_circles_random_cellcount_r4_t1100_s35_rollout:True_samestartloc_harborenv"
    ...
    weights_path = CONF[json_comp_conf]["neural_net_weights_path"] + "circles_21x21_epoch{}_random_oraclecellcount_r4_t1100_s35_rollout:True_samestartloc_batch128_harborenv".format(epochs)
