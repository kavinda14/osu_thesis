...
if __name__ == "__main__":
    ...
    # filename = CONF[json_comp_conf]["pickle_path"] + "data_41x41_depoeharbor_oracle_r6_t1100_s200_rollout:True"
    filename = CONF[json_comp_conf]["pickle_path"] + "data_21x21_circular_oracle_r8_t1100_s150_rollout:True"
    ...
    weights_path = CONF[json_comp_conf]["neural_net_weights_path"] + "depoeharbor_41x41_epoch{}_oracle_r8_t1100_s150_rollout:True_batch128".format(epochs)
    # weights_path = CONF[json_comp_conf]["neural_net_weights_path"] + "circular_21x21_epoch{}_oracle_r6_t1800_s60_rollout:True_batch128".format(epochs)
